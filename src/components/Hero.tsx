...
import heroImage from "@/assets/IMG_1528_LowQ.jpg";
  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundColor: "#f5f5dc", // Cor de fallback enquanto a imagem carrega
      }}
    >
      ...
      <div className="container mx-auto px-4 text-center text-white relative z-10 flex flex-col items-center justify-center py-24 animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up delay-200">
          ...
          >
            <Link to="/ementa">
              <FaUtensils aria-hidden="true" className="inline-block mb-0.5" /> Ver Ementa
            </Link>
          </Button>
          <Button
            variant="outline"
          ...
          >
            <FaRegCalendarAlt aria-hidden="true" className="inline-block mb-0.5" /> Reservar Mesa
          </Button>
        </div>
      </div>
      {/* Scroll indicator estilizado */}
      <div className="absolute bottom-8 left-0 right-0 flex flex-col items-center text-white z-10 animate-bounce" aria-hidden="true">
