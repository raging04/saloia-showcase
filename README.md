<div align="center">
  <img alt="Taberna Saloia Logo" src="public/favicon.ico" width="80" />
...
A pet project for the Taberna Saloia restaurant, based in Loures, Portugal. Built to provide a fast, appealing, and responsive experience for users, utilizing a modern ecosystem based on **React** and **Vite**. A large part of the code was AI-generated, using the **Google Gemini** models.
